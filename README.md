# MODEL1310110053: MODEL1310110053
...
`pip install git+https://github.com/biomodels/MODEL1310110053.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110053.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110053 as model`
...
Thiele2013 - Kidney cells in glomeruli

The model of kidney cells in glomeruli metabolism is derived from the
...
and identified by:
[MODEL1310110053](http://identifiers.org/biomodels.db/MODEL1310110053) .
